...
<html lang="fa">
    <head>
        ...
        <title>Hooshmand|| Products</title>
    </head>
    ...
    <body>
        ...
        <header class="header">
            <div class="banner">
              ...
              <a class="btn btn-banner" href="./products.php">محصولات</a>
            </div>
        </header>
        ...
        <section class="products">
            <div class="section-center clearfix">
                <article class="products-info">
                    ...
                    <a class="btn btn-products" href="products.html"
                        >مشاهده محصولات</a
                    >
                </article>
        ...
        <footer class="footer">
            <div class="section-center">
                ...
                <h4 class="footer-text">
                    <span class="company">hooshmandrobat.ir</span>
